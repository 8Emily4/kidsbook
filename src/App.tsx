...
const initialBooks: Book[] = [
  { id: 'b0', title: '모순', author: '양귀자', cover: 'https://books.google.com/books/publisher/content/images/frontcover/Hl4dAQAAQBAJ?fife=w400-h600&access=gbs_api', totalPages: 300, progress: 0 },
  { id: 'b1', title: '자개장 할머니', author: '안효림', cover: 'https://books.google.com/books/publisher/content/images/frontcover/80knEQAAQBAJ?fife=w400-h600&access=gbs_api', totalPages: 180, progress: 100 },
  { id: 'b2', title: '도서관에 간 사자', author: '미셸 누드슨', cover: 'https://books.google.com/books/publisher/content/images/frontcover/8n_mDwAAQBAJ?fife=w400-h600&access=gbs_api', totalPages: 240, progress: 46 },
  { id: 'b3', title: '마법의 숲', author: '에니드 블라이턴', cover: 'https://books.google.com/books/publisher/content/images/frontcover/vG9-DwAAQBAJ?fife=w400-h600&access=gbs_api', totalPages: 320, progress: 72 },
  ...
  const [books, setBooks] = useState<Book[]>(() => {
    ...
    return initialRaw.map((book: Book) => {
      ...
      const config: Record<string, { title: string, author: string, cover: string }> = {
        '모순': { title: '모순', author: '양귀자', cover: 'https://books.google.com/books/publisher/content/images/frontcover/Hl4dAQAAQBAJ?fife=w400-h600&access=gbs_api' },
        '자개장할머니': { title: '자개장 할머니', author: '안효림', cover: 'https://books.google.com/books/publisher/content/images/frontcover/80knEQAAQBAJ?fife=w400-h600&access=gbs_api' },
        '도서관에간용': { title: '도서관에 간 사자', author: '미셸 누드슨', cover: 'https://books.google.com/books/publisher/content/images/frontcover/8n_mDwAAQBAJ?fife=w400-h600&access=gbs_api' },
        '도서관에간사자': { title: '도서관에 간 사자', author: '미셸 누드슨', cover: 'https://books.google.com/books/publisher/content/images/frontcover/8n_mDwAAQBAJ?fife=w400-h600&access=gbs_api' },
        '마법의숲': { title: '마법의 숲', author: '에니드 블라이턴', cover: 'https://books.google.com/books/publisher/content/images/frontcover/vG9-DwAAQBAJ?fife=w400-h600&access=gbs_api' }
      };

      for (const [key, val] of Object.entries(config)) {
        if (cleanTitle.includes(key) && (book.cover !== val.cover || book.title !== val.title)) {
          return { ...book, ...val };
        }
      }
      return book;
