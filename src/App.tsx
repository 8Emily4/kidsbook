...
const initialBooks: Book[] = [
  { id: 'b0', title: '모순', author: '양귀자', cover: 'https://covers.openlibrary.org/b/isbn/9788998441012-L.jpg', totalPages: 300, progress: 0 },
  { id: 'b1', title: '자개장 할머니', author: '안효림', cover: 'https://covers.openlibrary.org/b/isbn/9791167552945-L.jpg', totalPages: 180, progress: 100 },
  { id: 'b2', title: '도서관에 간 사자', author: '미셸 누드슨', cover: 'https://covers.openlibrary.org/b/isbn/9788901213408-L.jpg', totalPages: 240, progress: 46 },
  { id: 'b3', title: '마법의 숲', author: '에니드 블라이턴', cover: 'https://covers.openlibrary.org/b/isbn/9788950993047-L.jpg', totalPages: 320, progress: 72 },
  ...
  const [books, setBooks] = useState<Book[]>(() => {
    ...
    return initialRaw.map((book: Book) => {
      ...
      const config: Record<string, { title: string, author: string, cover: string }> = {
        '모순': { title: '모순', author: '양귀자', cover: 'https://covers.openlibrary.org/b/isbn/9788998441012-L.jpg' },
        '자개장할머니': { title: '자개장 할머니', author: '안효림', cover: 'https://covers.openlibrary.org/b/isbn/9791167552945-L.jpg' },
        '도서관에간용': { title: '도서관에 간 사자', author: '미셸 누드슨', cover: 'https://covers.openlibrary.org/b/isbn/9788901213408-L.jpg' },
        '도서관에간사자': { title: '도서관에 간 사자', author: '미셸 누드슨', cover: 'https://covers.openlibrary.org/b/isbn/9788901213408-L.jpg' },
        '마법의숲': { title: '마법의 숲', author: '에니드 블라이턴', cover: 'https://covers.openlibrary.org/b/isbn/9788950993047-L.jpg' }
      };
